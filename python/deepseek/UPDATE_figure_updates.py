...
class FeaturedUpdateUpdater:
    ...
    def create_featured_update_object(self, update_data):
        """
        ...
        return {
            ...
            'eventPointDescription': update_data.get('eventPointDescription', ''),
    ...
    def process_single_figure(self, figure_id, dry_run=False):
        ...
        featured_update = self.create_featured_update_object(latest_update)
