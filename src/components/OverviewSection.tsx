...
export default function OverviewSection({ publicFigure, mainOverview, spotifyArtistNames = [] }: OverviewSectionProps) {
    // console.log(spotifyArtistNames);
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            {/* About Section */}
            <div className="bg-white dark:bg-[#1d1d1f] rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                <h2 className="text-2xl font-bold mb-4 text-key-color dark:text-key-color-dark">
                    About {publicFigure.name}
                </h2>
                {mainOverview?.content ? (
                    <div className="prose prose-sm text-gray-700 dark:text-gray-300 max-w-none leading-relaxed">
                        <p dangerouslySetInnerHTML={{
                            __html: mainOverview.content
                                .replace(/\n/g, '<br />')
                                .replaceAll("*", "'")
                        }} />
                    </div>
